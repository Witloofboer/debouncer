...
#define LED_SetPushPull()    do { ODCONAbits.ODCA5 = 1; } while(0)
#define LED_SetOpenDrain()   do { ODCONAbits.ODCA5 = 0; } while(0)
...
#define Button_SetPushPull()    do { ODCONCbits.ODCC4 = 1; } while(0)
#define Button_SetOpenDrain()   do { ODCONCbits.ODCC4 = 0; } while(0)
